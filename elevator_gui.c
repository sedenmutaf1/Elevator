...
static void activate(GtkApplication *app, gpointer user_data) {
    ...
    gtk_box_pack_start(GTK_BOX(box), state->status_grid, TRUE, TRUE, 4);
    gtk_box_pack_start(GTK_BOX(box), state->average_label, FALSE, FALSE, 4);
...
int main(int argc, char **argv) {
    ...
    GtkApplication *app = gtk_application_new("edu.ozyegin.cs350.elevator", G_APPLICATION_DEFAULT_FLAGS);
